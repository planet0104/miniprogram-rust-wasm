...
(function (root, factory) {
  ...
  return (function (module_factory) {
    ...
    if (typeof window === "undefined" && typeof process === "object") {
      ...
      var wasm_path = path.join(__dirname, "hello.wasm");
      ...
      var loadFile = new Promise(function (resolve, reject) {
        wx.request({
          url: 'https://planet0104.github.io/hello.wasm.txt',
          responseType: "text",
      ...
      //var file = fetch("hello.wasm", { credentials: "same-origin" });
      ...
      return wasm_instance
        .then(function (wasm_instance) {
          ...
          console.log("Finished loading Rust wasm module 'hello'");
          return exports;
        })
        .catch(function (error) {
          console.log("Error loading Rust wasm module 'hello':", error);
          throw error;
        });
    }
  }(function () {
    ...
    return {
      imports: {
        env: {
          "__extjs_76a96b3bedea65a1b66a69d567c207919128318e": function ($0, $1) {
