...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        var wasm_instance = loadFile.then(function (bytes) { return WebAssembly.compile(bytes); })
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.sha1 = function sha1(string) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.sha1(Module.STDWEB_PRIVATE.prepare_any_arg(string)));
}
;
            __web_on_grow();
